...
import { simonSays as simonSaysModular } from "./streamer-wars/minigames";
...
export const eliminatePlayer = async (playerNumber: number) => {
    try {
        ...
        /* 
            If Simon Says is active, atomically remove the player
        */
        await simonSaysModular.handleExternalElimination(playerNumber);
