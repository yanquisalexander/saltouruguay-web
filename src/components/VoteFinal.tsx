        ...
        <div className="w-full max-w-4xl mx-auto animate-fade-in-up">
            ...
            {votesSent ? (
                ...
                <div
                    ...
                    className="flex flex-col items-center justify-center text-center p-6 md:p-16 rounded-3xl border border-green-500/30 bg-linear-to-b from-green-900/10 to-black/60 backdrop-blur-md shadow-2xl"
                >
