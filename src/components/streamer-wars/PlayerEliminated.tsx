...
export const PlayerEliminated = ({ playerNumber, session }: { playerNumber: number | null, session: Session }) => {
    ...
    */
    ...
    return (
        <div class={`z-[6000] bottom-0 left-0 right-0 min-h-screen w-full hide-scroll-page bg-black/90 p-4 flex items-center justify-center transition animate-duration-[2500ms] ${showing ? "animate-fade-in" : "animate-fade-out pointer-events-none"}`}>
