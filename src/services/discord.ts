...
export const addRoleToUserWithoutLogging = async (guildId: Snowflake, discordUserId: Snowflake, roleId: Snowflake) => {
    return discord.put(Routes.guildMemberRole(guildId, discordUserId, roleId))
}
